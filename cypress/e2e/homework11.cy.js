...
//edit account details
   ...
   cy.get('#AccountFrm_firstname').type("ani").should("have.value", "ani")
   cy.get('#AccountFrm_lastname').clear().type("kirkitadze").should("have.value","kirkitadze")
